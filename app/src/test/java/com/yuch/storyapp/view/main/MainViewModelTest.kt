...
import com.yuch.storyapp.DataDummy
import com.yuch.storyapp.MainDispatcherRule
...
import com.yuch.storyapp.getOrAwaitValue
...
class MainViewModelTest {
    ...
    fun `when Get Quote Should Not Null and Return Data`() = runTest {
        ...
        val actualQuote: PagingData<ListStoryItem> = mainViewModel.getStoryPagingData().getOrAwaitValue()
